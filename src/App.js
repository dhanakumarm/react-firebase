  ...
  return (
    <div className="App">
      <header className="App-header">
        <h1>Dogs Test test test test</h1>
      ...
      <footer>
        <div className="images">
          <div className="column">
            <img src="https://images.dog.ceo/breeds/bluetick/n02088632_101.jpg" />
          </div>
          ...
          <div className="column">
            <img src="https://images.dog.ceo/breeds/bluetick/n02088632_1047.jpg" />
          </div>
